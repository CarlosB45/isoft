                  ...
                  <tr key={index}>
                    <td>
                      <select
                        value={cita.paciente}
                        onChange={(e) =>
                          handleModificarCita(index, 'paciente', e.target.value)
                        }
                      >
                    ...
                    <td>
                      <input
                        ...
                        value={cita.fecha}
                        onChange={(e) =>
                          handleModificarCita(index, 'fecha', e.target.value)
                        }
                      />
                    </td>
                    <td>
                      <input
                        ...
                        value={cita.motivo}
                        onChange={(e) =>
                          handleModificarCita(index, 'motivo', e.target.value)
                        }
                      />
                    </td>
                    <td>
                      <button onClick={() => console.log('Guardar cambios')}>
                        Guardar
                      </button>
                    </td>
                  </tr>
