...
const Consultarhistorial = () => {
  ...
  const buscarConsultas = () => {
    ...
    { paciente: 'John Doe', fecha: '2023-06-24', historial: 'Consulta general' },
    { paciente: 'Jane Smith', fecha: '2023-06-25', historial: 'Examen de rutina' },
          ...
          <div>
            ...
            <ul>
              {resultados.map((resultado, index) => (
                <li key={index}>
                  Paciente: {resultado.paciente},Fecha:{resultado.fecha}, Historial: {resultado.historial}
                </li>
              ))}
            </ul>
          </div>
